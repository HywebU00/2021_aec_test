$(function() {
    ...
    var headerHeight = Math.floor($('.header').outerHeight(true)),
        customHeight = 164 - 40; // header高度 - menu高度，每個專案不同，請另外填寫。
    ...
    $('.font_size').find('.small').click(function(e) {
        ...
        $('.innerpage .cp').removeClass('large_size').addClass('small_size');
    ...
    $('.font_size').find('.medium').click(function(e) {
        $(this).parent('li').siblings('li').find('a').removeClass('active');
        $('.innerpage .cp').removeClass('large_size small_size');
        $(this).addClass('active');
        e.preventDefault();
    ...
    $('.font_size').find('.large').click(function(e) {
        $(this).parent('li').siblings('li').find('a').removeClass('active');
        $('.innerpage .cp').removeClass('small_size').addClass('large_size');
        $(this).addClass('active');
        e.preventDefault();
    ...
    window.onload = function(e) {
        ...
        if (cookie == 'small') {
            ...
            $('.innerpage .cp').removeClass('large_size medium_size').addClass('small_size');
            ...
            if (cookie == 'large') {
                ...
                $('.innerpage .cp').removeClass('small_size medium_size').addClass('large_size');
